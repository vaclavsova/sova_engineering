...
3D modely na těchto stánkách ke stažení jsou poskytovány pod licencí Creative Commons Attribution-NonCommercial 4.0 International ([CC BY-NC 4.0](https://creativecommons.org/licenses/by-nc/4.0/))
...
Použití modelu je na vlastní odpovědnost. Autor nenese odpovědnost za škody, poranění ani následky vzniklé použitím modelu nebo výrobku podle něj vytvořeného.
